...
system_prompt = load_prompt("chatbot3_halucynujacy.md")

# === Konfiguracja strony ===
st.set_page_config(page_title="Analiza trzeciego przypadku medycznego", layout="wide")
st.markdown("<h1 class='chat-title'>🧠 Analiza trzeciego przypadku medycznego</h1>", unsafe_allow_html=True)
...
user_input = st.chat_input("Wpisz wiadomość...", key="chatbot3_input")
